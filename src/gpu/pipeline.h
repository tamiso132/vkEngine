...
// 1. Start (Returns builder with valid defaults: No depth, Triangle List, No blend)
GpBuilder gp_init();
...
void gp_enable_blend(GpBuilder* b); // Simple Alpha Blend
...
// 4. Hot Reloading
// Register a stable pointer to a pipeline struct so it can be updated automatically
// when the shader files change.
