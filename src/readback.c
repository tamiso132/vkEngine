...
// --- Private Prototypes ---
static void decode_record_to_editor(EditorPixelEditor *ed, uint32_t px, uint32_t py, const u32 *data);
...
ResHandle readback_get_handle(ReadBackBuffer *self) { return self->buffer; }
